...
public class ViewForcePasswordChange {
	...
	*/
	...
	protected static String actualPassword = "";
	...
	*/
	...
	button_checkPass.setOnAction((event) ->
			{
				if(ControllerForcePasswordChange.checkPass() ) {
					if(Password1.compareTo(Password2) == 0) {
					button_setPass.setDisable(false);
					label_Pass1Valid.setText("Password is valid!");
					} else label_Pass1Valid.setText("Passwords must match!");
					
				}
					
				else label_Pass1Valid.setText("**Password is invalid**");
				});
